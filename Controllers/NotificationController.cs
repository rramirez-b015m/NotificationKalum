    ...
    public class NotificationController : ControllerBase
    {
     ...
     public ActionResult<NotificationResponseDTO> SendEmail([FromBody] NotificationRequestDTO notification)
     {
        ...
        try
        {
            ...
            email.From.Add(new MailboxAddress("Kalum Notification", "rbnstrdramirez@gmail.com"));
            ...
            email.Body = new TextPart(MimeKit.Text.TextFormat.Html) {
                Text = $"<h2><b>Su número de {(string.Equals(notification.Type, "expediente", StringComparison.OrdinalIgnoreCase)?"Expediente":"Carné")} fue creado con éxito, haz click en el siguiente link para completar el proceso</b></h2><hr>{notification.Body}"
            };
            using (var smtp = new SmtpClient()) {
                smtp.Connect("smtp.gmail.com", 465, true);
                smtp.Authenticate("rbnstrdramirez", "vdcfcwfwefxeaxcm");
                smtp.Send(email);
